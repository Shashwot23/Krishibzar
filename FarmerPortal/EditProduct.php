                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="text-center font-weight-bold">Edit Your Product <i class="fas fa-leaf"></i></h4>
                            </div>
                            <div class="card-body">
...
if (isset($_POST['confirm'])) {
   ...
   $product_delivery = mysqli_real_escape_string( $con, $_POST['product_delivary']);

    

    $query = "update products 
              set product_title = '$phone', product_cat = '$product_cat',
             product_type = '$product_stock',
              product_stock = '$product_stock',product_price = $product_price, product_expiry = $product_expiry,
              product_desc = $product_desc, product_keywords = $product_keywords, product_delivary = $product_delivery
              where product_id 
