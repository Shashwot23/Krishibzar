               ...
               <div class="container">
                    <div class="row text-center text-xs-center text-sm-left text-md-left">
                         <div class="col aligncenter">
                              ...
                              <img src="../Images/Website/esewa.jpg" alt="E-sewa" style="height:37px">
                              <img src="../Images/Website/khalti.jpg" alt="Khalti" style="height:37px">
							  <img src="../Images/Website/cod.jpeg" alt="COD" style="height:37px">
                         </div>
                    </div>
                    <div class="row">
