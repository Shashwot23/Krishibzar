	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">Buyer Registration</h4></div>
...
$code=mt_rand(100000,999999); //generate random 6 digit code
    ...
    require 'C:\xampp\htdocs\krishibzar\phpmailer\src\Exception.php';
    require 'C:\xampp\htdocs\krishibzar\phpmailer\src\PHPMailer.php';
    require 'C:\xampp\htdocs\krishibzar\phpmailer\src\SMTP.php';
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		echo "<script>window.open('conformation.php','_self')</script>";
