...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="../Images/HomePage/krishi.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="../Images/HomePage/krishi.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
</a>
        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    <br>
                    <div><b>
                            <h3><img src="../Images/HomePage/iconsmall.png"> Prashant Karki
                        </b></h3>
                    </div>
                    <img class="card-img-top" src="../Images/Fruits/strawberry.jpg" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card  pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    ...
                    <img class="card-img-top pic" src="../Images/Fruits/strawberry.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Strawberry</h5>
                        <p class="card-text">PRICE:-20rs/kg</p>
                        <div class="input-group mb-3">
        ...
        <div class="row mt-3">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    ...
                    <img class="card-img-top" src="../Images/Fruits/strawberry.jpg" alt="Card image cap" height="315px">
                    <div class="card-body">
                        <h5 class="card-title">Strawberry</h5>
                        <p class="card-text">PRICE:-20rs/kg</p>
                        <div class="input-group mb-3">
