                            ...
                            <div class='text-center mt-2 ''>
                                ...
                                <form actions='' method='post'>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12'> 
                                        <a href='saveforlater.php' class='btn btn-warning border-secondary saveforlater' style='color:black'padding:2px;'><b>Save For later</b><img src='saveforlater.png' class='ml-1 mb-1'></a></div>
                                    </div>
                                </form>
