...
<div class=" flex-row-reverse right ">
    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-5">
            ...
            <div class="payment">
                <h4>Payment Options :-
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="E-sewa" required>
                    <img src="../Images/Website/esewa.jpg" alt="E-sewa" class="E-sewa" style="height:40px">
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="Khalti" required>
                    <img src="../Images/Website/khalti.jpg" alt="Khalti" class="Khalti" style="height:40px">

                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="COD" required>
                    <img src="../Images/Website/cod.jpeg" alt="COD" class="COD" style="height:40px">
                </h4>
            </div>
